      ...
      <div>
        ...
        <table style={{ borderCollapse: 'collapse', marginBottom: '1.5rem' }}>
          <tbody>
            ...
            {meta.availability && <tr><td style={metaLabelStyle}>Availability</td><td>{[...meta.availability].sort((a, b) => DAY_ORDER.indexOf(a) - DAY_ORDER.indexOf(b)).map(d => DAY_LABELS[d] || d).join(', ')}</td></tr>}
            {meta.long_run_day && <tr><td style={metaLabelStyle}>Long Run Day</td><td>{DAY_LABELS[meta.long_run_day] || meta.long_run_day}</td></tr>}
